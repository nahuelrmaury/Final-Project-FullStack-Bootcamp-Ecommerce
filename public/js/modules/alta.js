...
class PageAlta {
    ...
    static validators = {
        ...
        'descriptionLarge': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,2000}$/,
        'image': /([a-z\-_0-9\/\:\.]*\.(jpg|jpeg|png|gif|webp))/i,
        'cantidad': /^\d+$/
    };

    static emptyForm() {
        PageAlta.fields.forEach(function (field) {
    ...
    static async addTableEvents() {
        ...
        const editProduct = async e => {
            ...
            const descriptionLarge = row.querySelector('.cell-descriptionLarge').innerHTML;
            const image = row.querySelector('.cell-image').innerHTML;
            const cantidad = 1;
            const productToEdit = {};
            productToEdit.id = id;
            ...
            productToEdit.descriptionLarge = descriptionLarge;
            productToEdit.image = image;
            productToEdit.cantidad = cantidad;
